...
public:
    ...
    SongWordDialog *getSongWordDialog();
    ...
    SendCoinsReturn prepareTransaction(WalletModelTransaction &transaction, CCoinControl& coinControl, const bool songword = false);
