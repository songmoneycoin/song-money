...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Songmoney address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and songmoney: URIs)"));
    ...
    songWordAction = new QAction(platformStyle->SingleColorIcon(":/icons/send"), tr("&SongWord"), this);
    songWordAction->setStatusTip(tr("Send coins with SongWord"));
    songWordAction->setToolTip(songWordAction->statusTip());
    songWordAction->setCheckable(true);
    songWordAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    tabGroup->addAction(songWordAction);
    ...
    connect(songWordAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(songWordAction, &QAction::triggered, [this]{ gotoSongWordPage(); });
#endif // ENABLE_WALLET
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Songmoney addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Songmoney addresses"));
    ...
    openAction->setStatusTip(tr("Open a songmoney: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Songmoney command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        toolbar->addAction(songWordAction);
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    songWordAction->setEnabled(enabled);
}
...
void BitcoinGUI::gotoSongWordPage()
{
    if (walletFrame) walletFrame->gotoSongWordPage();
}
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Songmoney network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Songmoney"); // default title
