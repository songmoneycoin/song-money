...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " songmoney-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  songmoney-tx [options] <hex-tx> [commands]  Update hex-encoded songmoney transaction\n" +
            "or:     songmoney-tx [options] -create [commands]   Create hex-encoded songmoney transaction\n" +
            "\n";
